# 1-layer MVPN - cope 1-4 total prediction
import sys, os, time
...
save_dir = '/gsfs0/data/fangmg/MVPD/model/model_runs/MVPD_net_' + sub + '/' + sub + '_copeAll_1layer100_relu/MVPD_net_' + sub + '_testrun' + str(this_run) + '_epoch' + str(num_epochs) 
