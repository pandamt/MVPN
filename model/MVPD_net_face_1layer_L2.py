# 1-layer L2 MVPN  - cope1(face) prediction
...
save_dir = '/gsfs0/data/fangmg/MVPD/model/model_runs/MVPD_net_' + sub + '/' + sub + '_cope1_face_0.1L2/MVPD_net_' + sub + '_testrun' + str(this_run) + '_epoch' + str(num_epochs) 
...
if __name__ == "__main__":
    ...
    face_train.get_train(this_run, total_run-1)
    ...
    face_test.get_test(this_run, total_run-1)
