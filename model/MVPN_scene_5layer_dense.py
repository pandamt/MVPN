...
save_dir = '/gsfs0/data/fangmg/MVPD/model/model_runs/MVPD_net_' + sub + '/' + sub + '_cope3_scene_5layer100_dense/MVPD_net_' + sub + '_testrun' + str(this_run) + '_epoch' + str(num_epochs) 
