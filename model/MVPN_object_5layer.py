# 5-layer MVPN - cope3(object) prediction
import sys, os, time
import numpy as np
...
save_dir = '/gsfs0/data/fangmg/MVPD/model/model_runs/MVPD_net_' + sub + '/' + sub + '_cope3_object_5layer100/MVPD_net_' + sub + '_testrun' + str(this_run) + '_epoch' + str(num_epochs) 
