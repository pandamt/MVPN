# 5-layer MVPN - cope4(scene) prediction
import sys, os, time
...
save_dir = '/gsfs0/data/fangmg/MVPD/model/model_runs/MVPD_net_' + sub + '/' + sub + '_cope4_scene_5layer100/MVPD_net_' + sub + '_testrun' + str(this_run) + '_epoch' + str(num_epochs) 
