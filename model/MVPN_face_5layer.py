# 5-layer MVPN - cope1(face) prediction
import sys, os, time
import numpy as np
...
save_dir = '/gsfs0/data/fangmg/MVPD/model/model_runs/MVPD_net_' + sub + '/' + sub + '_cope1_face_5layer100/MVPD_net_' + sub + '_testrun' + str(this_run) + '_epoch' + str(num_epochs) 
